export declare class APIHelper {
    ...
    post(endpoint: string, data?: any, headers?: Record<string, string>): Promise<import("playwright-core").APIResponse>;
    put(endpoint: string, data?: any, headers?: Record<string, string>): Promise<import("playwright-core").APIResponse>;
